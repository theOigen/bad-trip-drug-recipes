              ...
              <div className="d-flex justify-content-center flex-wrap">
                ...
                <div className="d-flex justify-content-start flex-wrap recipe-step1-user-number">
                  ...
                  <div className="stepper-content py-1 first-step-content d-flex flex-row justify-content-left">
                    ...
                    <input type="text" name="text" className="form-control my-form-control recipe-key  d-flex flex-row" placeholder="Особистий ключ (Key-6.dat, *.pfx, *.p..." aria-describedby="basic-addon2" />
                  </div>
                  <div className="line-break"></div>
                </div>
                ...
                <div className="d-flex justify-content-start flex-wrap recipe-step1-user-number">
                  ...
                  <div className="stepper-content py-1 first-step-content d-flex flex-row justify-content-left">
                    <input type="text" name="text" className="form-control my-form-control recipe-password  d-flex flex-row" placeholder="Введіть пароль захисту ключа" aria-describedby="basic-addon2" />
                  </div>
                  <div className="line-break"></div>
                </div>
